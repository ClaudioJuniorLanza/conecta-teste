...
dAL::layTop(array('bodyTitle' => "Gerenciar os renasens", 'saveGoBack' => true));
dAL::goBack(false, "<a href='raw_renasem_edit.php'>Cadastrar novo renasem</a>");
...
dHelper2::includePage('inc/dAL.SearchBox2.inc.php', array(
        'className' => 'cRenasem',
        'colTitles' => 'Cód, Uf, Cidade, Renasem, Valido status, Valido expira, Atividade, CPF/CNPJ, Nome, Endereco, Cep',
        'colFields' => '!id, uf, cidade, renasem, valido_status, valido_expira,!atividade,!cpf_cnpj,!nome,!endereco,!cep',
        'inlineEdit' => 'nome',
